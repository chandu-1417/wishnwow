...
import img1 from '../../assets/gallery/PlatinumTheatre/v3platinum1.jpg';
import img2 from '../../assets/gallery/PlatinumTheatre/v3platinum2.jpg';
import img3 from '../../assets/gallery/PlatinumTheatre/v3platinum3.jpg';
import img4 from '../../assets/gallery/PlatinumTheatre/v3platinum4.jpg';
import TheatreimagesSlider from '../TheatreimagesSlider';


const PlatinumTheatre = () => {
    const [show, setShow] = useState(false);
    const [selectedIndex, setSelectedIndex] = useState(0);
    const PlatinumTheatre = [img1, img2, img3, img4];
    ...
    return (
        <div className='w-full relative tracking-wide mt-8 md:mt-12 overflow-hidden px-4 md:px-0'>
            <div className="text-xl md:text-2xl font-medium mb-6 ml-[6vw]">Platinum Theatre</div>

            <div className='flex flex-wrap gap-4 md:gap-6 justify-center mx-auto max-w-[90vw]'>
                {PlatinumTheatre.map((img, index) => (
                    <div 
                        key={index} 
            ...
            {show && (
                <TheatreimagesSlider 
                    sapphireTheatreImages={PlatinumTheatre} 
...
export default PlatinumTheatre